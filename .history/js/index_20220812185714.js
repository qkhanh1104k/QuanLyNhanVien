...
function createStaff() {
  ...
  valid &=
    ...
    kiemTraPassword(staff.password, "#tbMatKhau", "Mật khẩu");
...
var searchStaff = function(){
  var tuKhoa = document.querySelector("#btnTimNV").value;
  var output = [];
  for (var index = 0; index < staffList.length;index++){
    var loaiNhanVien = removeVietnameseTones(staffList[index].username);
    if(loaiNhanVien.search(tuKhoa)!=1 || staffList[index].username == tuKhoa){
